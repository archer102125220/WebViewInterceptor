...
> [!NOTE]
> 關於 Android Chromium 在底層 Event Loop 中對 Macrotask 與 Microtask (Promise) 的 5 秒寬限期處理，已統一整理於：[async_popup_blocker_history.md](file:///Users/parkerchen/Desktop/code/WebViewInterceptorDemo/knowledge/async_popup_blocker_history.md) 的第 4 節。
